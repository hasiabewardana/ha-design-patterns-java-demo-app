package org.example.solid.singleresponsibility.violation;

import java.io.IOException;

//Main class to test
public class NoSingleResponsibilityDemo {
	...
	public static void contactController() throws IOException {
